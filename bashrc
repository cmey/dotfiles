# BASH ALIASES
alias bbh='pushd $BNI_ROOT/../software  &&  git clean -ffdx  &&  pushd $BNI_ROOT  &&  rm -rf SDK-oldworking && mv -f SDK SDK-oldworking 2> /dev/null || true  &&  popd  &&  build-bni-software  &&  popd'
