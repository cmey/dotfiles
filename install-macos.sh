...
brew install blitz cheat ctags findutils fzf gifsicle glances gpg grip htop imagemagick mas mplayer postgresql ranger r ripgrep stow thefuck tmux tree
brew install vim
