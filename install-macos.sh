...
brew install blitz cheat cmake ctags findutils fzf gifsicle glances gpg grip htop imagemagick mas mplayer postgresql ranger r ripgrep stow tmux tree zsh zsh-syntax-highlighting
brew install vim
